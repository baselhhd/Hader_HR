...
export type Database = {
  ...
  public: {
    Tables: {
      attendance_records: {
        Row: {
          ...
          method_used: Database["public"]["Enums"]["attendance_method"]
          notes: string | null
          overtime_hours: number | null
          selfie_data: Json | null
      ...
      color_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "color_codes_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
      ...
      custom_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_requests_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "custom_requests_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      location_managers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "location_managers_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      numeric_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "numeric_codes_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
      ...
      qr_codes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "qr_codes_used_by_fkey"
            columns: ["used_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      shifts: {
        Row: {
          ...
          id: string
          is_active: boolean | null
          late_arrival_buffer: number | null
          location_id: string | null
          name: string
          start_time: string
          updated_at: string | null
      ...
      verification_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "verification_requests_attendance_record_id_fkey"
          ...
          {
            foreignKeyName: "verification_requests_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "verification_requests_manager_id_fkey"
            columns: ["manager_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Enums: {
      attendance_method: "qr" | "color" | "code" | "manual"
      leave_type: "annual" | "sick" | "personal" | "emergency" | "unpaid"
      record_status: "pending" | "approved" | "rejected" | "suspicious"
      request_status: "pending" | "approved" | "rejected" | "expired"
      user_role: "super_admin" | "hr_admin" | "loc_manager" | "employee"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
